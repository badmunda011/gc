...
async def handle_long_message(update: Update, context: CallbackContext):
    ...
    if message and len(message.text.split()) > 50:  # Check if the message has more than 50 words
        try:
            ...
            warning_text = f"⚠️ {user.mention_html()}, your message exceeds 50 words and has been deleted."
